...
export interface IndividualAccountDeployVerifierInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptToken"
      | "acceptedTokens"
...
export interface IndividualAccountDeployVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IndividualAccountDeployVerifier;
  waitForDeployment(): Promise<this>;

  interface: IndividualAccountDeployVerifierInterface;
