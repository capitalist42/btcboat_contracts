...
export interface RelayHubInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addRelayWorkers"
      | "deployCall"
  ...
  decodeFunctionResult(functionFragment: "relayData", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "stakeForAddress",
    data: BytesLike
  ): Result;
...
export interface RelayHub extends BaseContract {
  connect(runner?: ContractRunner | null): RelayHub;
  ...
  workerCount: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;

  workerToManager: TypedContractMethod<[arg0: AddressLike], [string], "view">;
