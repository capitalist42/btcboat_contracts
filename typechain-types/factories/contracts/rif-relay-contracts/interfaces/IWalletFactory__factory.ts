...
} from "../../../../contracts/rif-relay-contracts/interfaces/IWalletFactory";
...
export class IWalletFactory__factory {
  ...
  static createInterface(): IWalletFactoryInterface {
    return new Interface(_abi) as IWalletFactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IWalletFactory {
    return new Contract(address, _abi, runner) as unknown as IWalletFactory;
  }
}
