...
contract Penalizer is IPenalizer {
    ...
    function _decodeTransaction(
        ...
        (
            ...
            transaction.value,
            transaction.data
        ) = RLPReader.decodeTransaction(rawTransaction);
        return transaction;
    }
    ...
    function penalizeRepeatedNonce(
        ...
        IRelayHub hub
    ) public override relayManagerOnly(hub) {
        ...
        require(
            !penalizedTransactions[txHash1] || !penalizedTransactions[txHash2],
        ...
        Transaction memory decodedTx1 = _decodeTransaction(unsignedTx1);
        Transaction memory decodedTx2 = _decodeTransaction(unsignedTx2);
        ...
        bytes memory dataToCheck2 = abi.encodePacked(
            decodedTx2.data,
            decodedTx2.gasLimit,
            decodedTx2.to,
            decodedTx2.value
        ...
        require(
            keccak256(dataToCheck1) != keccak256(dataToCheck2),
            "tx is equal"
        );
        ...
        hub.penalize(addr1, payable(msg.sender));
    }
}
